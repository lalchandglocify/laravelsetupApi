...
<!-- WebSite Title -->
<title> Easy 2 Inspect | {{ $title['title'] }} </title>
</head>
<body>
@php
...
@endphp
<!-- Top Head Part Start -->
	<header class="TopHead @if(end($explodeUrl)=='happyCustomers') CustomerRivewHeader @endif ">
		<div class="container">
			<div class="row">
				<nav class="navbar navbar-expand-md navbar-dark TopNavigation" data-sidebarClass="navbar-dark bg-dark">
			        ...
			        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
			            <ul class="nav navbar-nav nav-flex-icons ml-auto MenuList">
			                ...
			                <li class="nav-item">
			                    <a class="nav-link" href="{{ url('mobileApp')}}">Mobile App</a>
			                ...
			                <li class="nav-item dropdown">
			                	...
			                	@elseif(isset($userDetails) && $userDetails->user_type=='admin')
			                		<a class="nav-link" href="{{ url('userList') }}">Dashboard</a>
			                	@else
